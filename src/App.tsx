...
function normalizeAccess(value: unknown, user: any): UserAccess {
  ...
  return {
    ...
    canManagePersonnel: Boolean(record.canManagePersonnel || record.bossView || user?.bossView),
    canViewSettings: Boolean(record.canViewSettings || record.canManageScoring360 || record.canManagePersonnel || record.bossView || user?.bossView),
